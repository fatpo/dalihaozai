...
CREATE TABLE `activity` (
  ...
  `start_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP comment '活动开始时间，默认今天',
...
insert into activity(title, detail, link_url) values ('测试title', '天气很好的内容！', 'http://www.baidu.com');
